...
public class SerializeSupport {
    ...
    private static <E> E parse(byte[] buffer, int offset, int length, Class<E> eClass) {
        Object entry =
                serializerMap.getOrDefault(eClass, serializerMap.get(Object.class)).parse(buffer, offset, length);
    ...
    public static <E> byte[] serialize(E entry) {
        ...
        Serializer<E> serializer =
                (Serializer<E>) serializerMap.getOrDefault(entry.getClass(), serializerMap.get(Object.class));
        if (serializer == null) {
